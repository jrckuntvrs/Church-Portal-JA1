...
<div class="card">
	<div class="card-title p-2 rounded-top" style="background: #001629; color: white;">
		<h4 class="ml-2">Birthday Events</h4>
	</div>
	<div class="card-body">
			...
			<div class="container-fluid">
				<table class="table table-bordered table-stripped">
					...
					<tbody>
						<?php
						$i = 1;
						$qry = $conn->query("SELECT *,concat(Full_Name) as fullname from `tbl_birthday_event` order by Transaction_Date desc ");
...
<script>
	$(document).ready(function() {
		$('.view_TransactR').click(function() {
			...
			uni_modal("Birthday Event", "ja1_admin_birthday/view_birthday.php?id=" + $(this).attr('data-id'), "mid-large")
