...
<div class="card">
	<div class="card-title p-2 rounded-top" style="background: #001629; color: white;">
		<h4 class="ml-2">Funeral Services</h4>
	</div>
	<div class="card-body">
			...
			<div class="container-fluid">
				<table class="table table-bordered table-stripped">
					...
					<tbody>
						<?php
						$i = 1;
						$qry = $conn->query("SELECT *,concat(Full_Name) as fullname from `tbl_funeral_service` order by Transaction_Date desc ");
...
<script>
	$(document).ready(function() {
		$('.view_TransactR').click(function() {
			...
			uni_modal("Funeral Service", "ja1_admin_funeral_s/view_funeral_S.php?id=" + $(this).attr('data-id'), "mid-large")
