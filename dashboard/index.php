...
<?php require_once('inc/header.php') ?>
  <body class="layout-fixed layout-footer-fixed text-sm sidebar-mini control-sidebar-slide-open layout-navbar-fixed " data-new-gr-c-s-check-loaded="14.991.0" data-gr-ext-installed="" style="height: auto;">
    <div class="wrapper">
     ...
     <?php $page = isset($_GET['page']) ? $_GET['page'] : 'home_admin';  ?>
     <?php endif ?>
  ...
  <div class="modal fade" id="uni_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <button type='button' class='close setclose' id="closeunimodal1" data-dismiss='modal' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
      </div>
      <div class="modal-body">
      </div>
      <!--div class="modal-footer">
  ...
  <div class="modal fade" id="viewer_modal" role='dialog'>
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
              <button type="button" class="btn-close" id="close_unimodal32" aria-label='Close'><span class="fa fa-times"></span></button>
              <img src="" alt="">
      </div>
    </div>
  </div>
      ...
      <script>
        $("#close_unimodal32").click(function() {
