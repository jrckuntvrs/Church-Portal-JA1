...
<div class="card">
	<div class="card-title p-2 rounded-top" style="background: #001629; color: white;">
		<h4 class="ml-2">Child Dedication Events</h4>
	</div>
	<div class="card-body">
			...
			<div class="container-fluid">
				<table class="table table-bordered table-stripped">
					...
					<tbody>
						<?php
						$i = 1;
						$qry = $conn->query("SELECT *,concat(Full_Name) as fullname from `tbl_child_dedication_events` order by Transaction_Date desc ");
...
<script>
	$(document).ready(function() {
		$('.view_TransactR').click(function() {
			...
			uni_modal("Child Dedication Event", "ja1_admin_child_dedication/view_child_dedication.php?id=" + $(this).attr('data-id'), "mid-large")
