...
<div class="container-fluid" id="print_out">
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <p><b>Owner Name: </b><?php echo $Owner_Name ?></p>
            </div>
            <div class="col">
                <p><b>Contact Number: </b><?php echo $Contact_No ?></p>
            </div>
        </div>
        ...
        <?php if ($Status == 0) : ?>
            <footer class="modal-footer">
                ...
                <?php } else { ?>
                    ...
                    <button class="btn btn-primary" form="p_blessing" data-id="<?php echo $id ?>">Pay</button>
                <?php } ?>
            </footer>
        <?php endif ?>
    </form>
...
<script>
    $(document).ready(function() {
        ...
        $('#p_blessing').submit(function(e) {
            e.preventDefault();
            var _this = $(this);
            $('.err-msg').remove();
            start_loader();
            $.ajax({
                url: _base_url_ + "classes/Content.php?f=pay_blessing_event",
