...
<div class="container-fluid" id="print_out">
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <p><b>Name of Deceased: </b><?php echo $Deceased_Name ?></p>
            </div>
            <div class="col">
        ...
        <div class="row">
            <div class="col">
                <p><b>Date and Time of Service: </b><?php echo $DateTime_Event ?></p>
            </div>
            <div class="col">
                <p><b>Burial Location: </b><?php echo $Venue_Location ?></p>
            </div>
        </div>
        ...
        <?php if ($Status == 0) : ?>
            <footer class="modal-footer">
                ...
                <?php } else { ?>
                    ...
                    <button class="btn btn-primary" form="funeral_s" data-id="<?php echo $id ?>">Pay</button>
                <?php } ?>
            </footer>
        <?php endif ?>
    </form>
...
<script>
    $(document).ready(function() {
        ...
        $('#funeral_s').submit(function(e) {
            e.preventDefault();
            var _this = $(this);
            $('.err-msg').remove();
            start_loader();
            $.ajax({
                url: _base_url_ + "classes/Content.php?f=pay_funeral_s",
