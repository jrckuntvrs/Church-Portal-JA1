...
<div class="container-fluid" id="print_out">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col">
                <p><b>Celebrant Name: </b><?php echo $Celebrant_Name ?></p>
            </div>
            <div class="col">
                <p><b>Contact No.: </b><?php echo $Contact_Number ?></p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col">
                <p><b>Birthday Theme: </b><?php echo $Birthday_Theme ?></p>
            </div>
            <div class="col">
        ...
        <div class="row">
            ...
            <div class="col">
                <p><b>Total Guess: </b><?php echo $Total_Guess ?></p>
            </div>
            <div class="col">
                <?php if ($Gender == 'Male') { ?>
                    <p><b>Gender: </b>Male</p>
        ...
        <?php if ($Status == 0) : ?>
            <footer class="modal-footer">
                ...
                <?php } else { ?>
                    ...
                    <button class="btn btn-primary" form="birthday_event" data-id="<?php echo $id ?>">Pay</button>
                <?php } ?>
            </footer>
        <?php endif ?>
    </form>
...
<script>
    $(document).ready(function() {
        ...
        $('#birthday_event').submit(function(e) {
            ...
            start_loader();
            $.ajax({
                url: _base_url_ + "classes/Content.php?f=pay_birthday_event",
