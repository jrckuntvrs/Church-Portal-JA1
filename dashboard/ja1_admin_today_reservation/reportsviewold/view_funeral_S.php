    ...
    <div class="container">
        ...
        <form id="fs_update_form">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col">
                        <label for="DateTime_Event">Date and Time of Service: </label>
                        <input type="datetime-local" class="form-control" name="DateTime_Event" id="DateTime_Event" value="<?php echo isset($DateTime_Event) ? date("Y-m-d\\TH:i", strtotime($DateTime_Event)) : date("Y-m-d\\TH:i") ?>" required>
                    </div>
                    <div class="col">
