        ...
        <form id="birthday_update_form">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <label for="Catering_Service_Rent">Catering Service Rent:</label>
                        <input type="text" class="form-control" name="Catering_Service_Rent" id="Catering_Service_Rent" value="<?php echo $Catering_Service_Rent ?>">
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        <label for="Food_Equipment_Rent">Food/Equipment Rent:</label>
                        <input type="text" class="form-control" name="Food_Equipment_Rent" id="Food_Equipment_Rent" value="<?php echo $Food_Equipment_Rent ?>">
                    </div>
                    <div class="col">
            ...
            $.ajax({
                ...
                success: function(resp) {
                    if (typeof resp == 'object' && resp.status == 'success') {
                        end_loader();
                        location.href = _base_url_ + "dashboard/?page=ja1_admin_today_reservation";
                    } else {
                        alert_toast("An error occured", 'error')
                        console.log(resp);
                        end_loader();
