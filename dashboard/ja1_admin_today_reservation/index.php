...
<div class="card">
    <div class="card-title p-2 rounded-top" style="background: #001629; color: white;">
        <h4 class="ml-2">Today's Receive Reservation List</h4>
    </div>
    <div class="card-body">
...
<script>
    $(document).ready(function() {
        $('.view_TransactR').click(function() {
            //uni_modal("", "remittance/add_denomination.php?id=" + $(this).attr('data-id'), "modal-lg")
            if ($(this).attr('data-event') == 'Birthday Event') {
                uni_modal("Birthday Event", "ja1_admin_today_reservation/reportsview/view_birthday.php?id=" + $(this).attr('data-id'), "mid-large")
            } else if ($(this).attr('data-event') == 'Wedding Event') {
                uni_modal("Wedding Event", "ja1_admin_today_reservation/reportsview/view_wedding.php?id=" + $(this).attr('data-id'), "mid-large")
            } else if ($(this).attr('data-event') == 'Blessing Event') {
                uni_modal("Blessing Event", "ja1_admin_today_reservation/reportsview/view_blessing.php?id=" + $(this).attr('data-id'), "mid-large")
            } else if ($(this).attr('data-event') == 'Child Dedication Event') {
                uni_modal("Child Dedication Event", "ja1_admin_today_reservation/reportsview/view_child_dedication.php?id=" + $(this).attr('data-id'), "mid-large")
            } else if ($(this).attr('data-event') == 'Funeral Service') {
                uni_modal("Funeral Service", "ja1_admin_today_reservation/reportsview/view_funeral_S.php?id=" + $(this).attr('data-id'), "mid-large")
            }
        })
    })
</script>